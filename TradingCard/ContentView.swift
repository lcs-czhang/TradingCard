        ...
        NavigationStack{
            VStack {
                List {
                    ...
                    NavigationLink {
                        CardView(imageName: "yuji", forceName: "qun", characterName: "于吉", characterDescription: 
                                """
                                 蛊惑
                    ...
                    NavigationLink {
                        CardView(imageName: "wolongzhuge", forceName: "shu", characterName: "卧龙诸葛", characterDescription: """
                                 八阵
                        ...
                        IntroView(characterName: "卧龙诸葛", characterReference: "你可识得此阵？", imageName: "wolongzhugetou")
                    }
                }
            }
